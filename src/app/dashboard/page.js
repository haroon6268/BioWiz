        ...
        return (
            <div className="h-[95vh] p-[20px] text-white space-y-6 ">
                ...
                <div className="space-y-2">
                    ...
                    <div className="h-[200px] bg-light-green rounded-xl w-[100%] flex-shrink-0 text-[#333] p-4 backdrop:blur-3xl lg:h-[250px] lg:w-[100%] flex items-center justify-center">
                        <Button>
